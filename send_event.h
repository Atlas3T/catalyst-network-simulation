...
namespace simulation {
    ...
    class send_event : public message_event {
        ...
        public:
            send_event(t_t t, message m, uid_t from_node_id, std::vector<uid_t> to_node_ids, network_manager * nm): message_event(t, m, from_node_id,to_node_id) {net_manager = nm;};
        private:
