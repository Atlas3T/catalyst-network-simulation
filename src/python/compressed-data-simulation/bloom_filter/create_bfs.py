...
def create_list_of_bfs(producers_id, prob_false_positive, num_collected_quantities):
    producers_bf = []
...
def create_output(P, producers_id, producers_list_of_bfs, producers_bf):
...
def create_bfs(producers_id, prob_false_positive, num_collected_quantities, total_no_prod, num_collected_candidates):
    ...
    output = create_output(total_no_prod, producers_id, 
                           producers_list_of_bfs, producers_bf)

    for i in producers_id:
        print ("producer ",i," : ",output[i,:])
